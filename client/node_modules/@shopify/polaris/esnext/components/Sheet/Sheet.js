...
export function Sheet({ children, open, onClose, onEntered, onExit, }) {
    ...
    return (<Portal idPrefix="sheet">
      <CSSTransition findDOMNode={findDOMNode} classNames={isNavigationCollapsed ? BOTTOM_CLASS_NAMES : RIGHT_CLASS_NAMES} timeout={durationSlow} in={open} mountOnEnter unmountOnExit onEntered={onEntered} onExit={onExit}>
