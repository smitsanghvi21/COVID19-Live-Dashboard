...
export declare function PolarisTestProvider({ strict, children, i18n, appBridge, link, theme, mediaQuery, features: featuresProp, frame, }: PolarisTestProviderProps): JSX.Element;
export {};
