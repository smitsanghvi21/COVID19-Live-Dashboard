...
For projects that don’t use React, icons are also available as `*.svg` files in the `images` folder.

[Browse the list of SVG files](https://unpkg.com/@shopify/polaris-icons/images/), hosted on the unpkg CDN (Content Delivery Network).
